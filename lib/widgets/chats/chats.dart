...
class _ChatsState extends State<Chats> {
  ...
  Future _getChatsUsers() async {
    ...
    if (value == '1') {
      ...
      var res = await http.post('https://iraqibayt.com/api/chats/users/get_interseted_users', body: data);
  ...
  Future getUserUnreadMessages(String uid) async
  {
    ...
    try{
      var res = await http.post(
          'https://iraqibayt.com/api/chats/users/'+uid+'/get_unread_msgs_count',
      body: data);
      //print(res.body);
      //print('sending...');
      var body = json.decode(res.body);
                      ...
                      return InkWell(
                        onTap: ()
                        {
                          Navigator.of(context).push(new MaterialPageRoute(
                              builder: (BuildContext context) => new UserChat(userID: _rUsers[index].id.toString(),userName: _rUsers[index].name.toString(),)));
                        },
                        child: Card(
                          elevation: 3,
                          child: Padding(
                            ...
                            child: ListTile(
                              ...
                              trailing:
                              GFBadge(
                                color: _unreadMessages[index].toString() == '0' ? Colors.white : GFColors.DANGER,
