...
class My_Posts_favorits extends StatefulWidget {
  @override
  _My_Posts_favorits createState() => _My_Posts_favorits();
}

class _My_Posts_favorits extends State<My_Posts_favorits> {
  ...
  get_data() async {
    ...
    databaseHelper.get_my_posts_favorits(user_email,user_pass).whenComplete(() {
          ...
          children: <Widget>[
            Expanded(
              child:  is_loading
                  ...
                  : new BikeListItem(list1: databaseHelper.my_posts_favorits_list),)
...
class BikeListItem extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    if(list1.length > 0){
      ...
      List<dynamic> data = list1["data"]["posts"];
